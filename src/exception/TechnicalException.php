 ...
 *
 * Exception personnalisée pour représenter les erreurs techniques de l'application
 * (ex: problème de connexion à la base de données, erreur système).
 * Implémente JsonSerializable pour faciliter la sérialisation de l'exception en JSON.
 */
class TechnicalException extends Exception implements JsonSerializable
{
    /**
     * Constructeur de la classe TechnicalException.
     *
